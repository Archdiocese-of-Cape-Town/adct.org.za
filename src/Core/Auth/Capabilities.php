...
final class Capabilities
{
    ...
    public const EDIT_EVENTS = 'edit_adct_events';
    public const EDIT_OTHERS_EVENTS = 'edit_others_adct_events';
    public const EDIT_PRIVATE_EVENTS = 'edit_private_adct_events';
    public const EDIT_PUBLISHED_EVENTS = 'edit_published_adct_events';
    public const PUBLISH_EVENTS = 'publish_adct_events';
    public const READ_PRIVATE_EVENTS = 'read_private_adct_events';
    public const DELETE_EVENTS = 'delete_adct_events';
    public const DELETE_PRIVATE_EVENTS = 'delete_private_adct_events';
    public const DELETE_PUBLISHED_EVENTS = 'delete_published_adct_events';
    public const DELETE_OTHERS_EVENTS = 'delete_others_adct_events';
